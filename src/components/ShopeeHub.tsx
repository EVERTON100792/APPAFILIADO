...
export const ShopeeHub: React.FC<ShopeeHubProps> = ({ 
  ...
  const niches: { id: string; name: string; icon: string; keywords: string[]; validation: string[] }[] = [
    { id: "todos",     name: "Todos",       icon: "🔥", keywords: ["achadinhos shopee viral", "produtos inovadores tiktok", "utilidades domésticas"], validation: ["shopee", "viral", "tiktok"] },
    { id: "cozinha",   name: "Cozinha",     icon: "🍳", keywords: ["utensílios cozinha criativos", "acessórios airfryer shopee", "organizador cozinha viral", "panela antiaderente cerâmica", "conjunto potes herméticos", "itens cozinha tiktok"], validation: ["cozinha", "culinária", "pia", "gourmet", "panela", "copo", "prato", "utensílio", "alimento", "faca", "tempero", "mesa", "mop", "esfregão", "lixeira", "pote", "hermético", "fritadeira", "ralador", "tábua", "escorredor", "processador", "dispenser", "afiador", "esponja", "balança", "airfryer", "frigideira", "forma", "cortador"] },
    { id: "tech",      name: "Eletrônicos",   icon: "⚡", keywords: ["gadgets tecnológicos úteis", "fone bluetooth pro viral", "smartwatch ultra 9", "drone barato câmera"], validation: ["fone", "carregador", "usb", "smart", "relógio", "celular", "fio", "cabo", "teclado", "mouse", "led", "gadget", "computador", "gaming", "headset", "caixa som", "tripé", "ring light", "power bank", "adaptador", "drone"] },
    ...
    { id: "kids",      name: "Kids & Brinquedos", icon: "🧸", keywords: ["brinquedo montessori viral", "brinquedo educativo tiktok", "drone infantil", "copo treinamento antivazamento"], validation: ["brinquedo", "criança", "bebê", "baby", "infantil", "jogo", "educativo", "maternidade", "mamadeira", "chupeta", "fralda", "urso", "boneca", "carrinho", "lousa", "pelúcia", "slime", "popit", "drone"] },
    { id: "utilidades", name: "Utilidades",  icon: "💡", keywords: ["utilidades domésticas criativas", "achadinhos shopee viral", "limpeza prática viral"], validation: ["utilidade", "organizador", "gaveta", "closet", "caixa", "arrumação", "cabide", "suporte", "prateleira", "gancho", "divisória", "cesto", "maleta", "sapateira", "colmeia", "organizadora", "limpeza", "mop", "vassoura", "aspirador", "pano", "balde", "esfregão", "lavar", "sujeira", "escova", "esponja", "detergente", "rodo", "limpador", "desinfetante"] },
  ];
